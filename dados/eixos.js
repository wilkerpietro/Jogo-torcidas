  ...
  base: [
    {id:'punho_cruzado', nome:'União Punho Cruzado', sigla:'UPC',
     membros:['independente','mafia_azul','jovem_fla','jovem_sport',
              ...
              'dragoes_da_real','pavilhao_independente','jovem_chape',
              'camisa_12_do_vitoria','os_imbativeis']},
    {id:'dedo_pro_alto', nome:'Dedo pro Alto', sigla:'DPA',
     membros:['mancha_verde','forca_jovem_vasco','galoucura',
              ...
              'dragoes_alviverdes','esquadrao_atleticano','super_raca_gremista',
              'ira_jovem_do_vasco','mancha_azul_do_csa','tup','forca_jovem_goias',
              'imperio_alviverde','mancha_azul','ira_jovem_do_gama',
    ...
    {id:'lado_a', nome:'Lado A', sigla:'LADO A',
     membros:['leoes_da_tuf','mafia_vermelha','inferno_coral','trovao_azul',
              ...
              'furia_jovem_baraunas','mancha_negra_do_asa','raca_coral',
              'furia_jovem_ypiranga']},
    {id:'lado_b', nome:'Lado B', sigla:'LADO B',
     membros:['cearamor','tubaroes_da_fiel','esporao_do_galo','garra_alvinegra',
              ...
              'furia_icasiana','alianca','imperio_vermelho','comando_alvinegro',
              'ultras_do_abc','forca_alviverde','furia_do_botafogo_pb',
              'terror_bicolor','faccao_jovem_paysandu','gavirmaos','mofi']},
