...
12. **O boneco a pé (4.51, 4.52) anda numa rua vazia**, e o chão só tem
    ...
    de 2ª geração.
13. **Os três estádios do jogo (4.57, 4.58) estão na escala de verdade**, e o
    ...
    lugar que o nome (33,5 mil e 75,1 mil). O corredor, os vomitórios e
    os portões estão no modelo (e o conferidor prova o caminho de cada
    torcida), mas a torcida, a briga e a PM entrando são do jogo.
