...
- Não tem **torcida** (a arquibancada está vazia), **cobertura** (as fotos não mostram), **o de dentro** (o corredor debaixo da arquibancada, o banheiro, o bar: o vomitório acaba na boca do túnel) nem **luz no de 40** (a foto não mostra torre nem refletor). A fachada é a mesma textura nos três.
...
12. **O boneco a pé (4.51, 4.52) anda numa rua vazia**, e o chão só tem
    ...
    de 2ª geração.
13. **Os três estádios do jogo (4.57) estão na escala de verdade**, e o
    jogo e os mapas, no estádio comprimido: pra usar, a vaga de estádio
    cresce (umas quatro vezes no de 40) ou o jogo passa a ter estádio de
    tamanho real. E a planta da foto do de 20 e do de 40 dá bem mais
    lugar que o nome (33,7 mil e 75,4 mil).
...
- `combate.js`, `arredores.js`, `cenario.js`, `ponte.js`, `cena3d.js`,
  ...
  o módulo faz exatamente o que fazia.)
...
| `js/diajogo/estadios3d.js` | os três estádios do jogo (4.57): o de 10, o de 20 e o de 40 mil, medidos nas fotos do protótipo — a família de anéis (o retângulo arredondado que fecha, o caminho aberto do de 10), a arquibancada (degrau, escada, vomitório, mureta, corte, ponta), o campo pintado, o gol, o banco, a torre de luz, a placa, o muro e o portão, a camada dos setores do dono (a cor, o nome, a faixa, os túneis, a lotação de cada um) e o `.glb` (`glbDoEstadio`); a textura é pintada ali mesmo, em canvas. Por enquanto só a aba Modelos 3D da planta usa |
