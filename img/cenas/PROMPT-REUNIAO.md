...
dentro da sede. A roda de cadeiras é o palco: os diretores sentados, o
presidente — o jogador — em pé na abertura da roda, virado pra eles, e
cada pauta da reunião abrindo um balão em cima de um diretor. Mesmo
...
| | |
|---|---|
| **quem está lá** | a diretoria inteira da torcida, um boneco por cadeira (teto de 12), **sentada**; o presidente em pé na abertura da roda, virado pra ela |
| **as cadeiras** | a foto tem as cadeiras VAZIAS, em roda. O jogo senta o boneco em cima de cada uma (`D.cadeiras`, posição e rumo) |
...
| **o presidente** | é o jogador: fica em pé na frente da roda; anda pela sala se quiser, mas a reunião não é cena de andar |
...
- **uma sala grande, vazia no meio**: é lá que a roda cabe. Nada de
  mesa no centro — a roda é de cadeiras, sem mesa;
- **as cadeiras de plástico, brancas ou cinza, em roda com uma
  abertura**: umas 12, encostadas umas nas outras não, com um vão de
  gente entre elas. A abertura da roda fica virada pra porta da sala.
  Cadeira vazia: **sem gente nenhuma**;
- **o resto da sede em volta** — a cozinha com o balcão, o depósito com
  ...
  aparecer, porque é a sede; mas a sala da roda tem de ser a maior
  peça e ficar no meio do quadro;
...
> and empty, with twelve white plastic chairs arranged in a wide circle
> with one opening in the circle facing the hall's wide doorway. The
> chairs are empty. Around the hall, smaller rooms of the same
...
table in the middle of the circle, cars inside the building.
...
2. abrir `arredores.html#reuniao`, apertar **F2** e acertar a máscara e
   as marcas: as 12 cadeiras (`cadeiras`), o lugar do presidente
   (`presidente`) e a porta (`entradas`);
